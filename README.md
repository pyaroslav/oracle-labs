...
| [`patching/`](patching/) | **Read-only** — inspect your patch level, binary inventory (`opatch lspatches`), and the SQL-patch registry (`DBA_REGISTRY_SQLPATCH`). | *Oracle Patching, Demystified: CPU, RU, RUR — and What Changed in 2026* |
